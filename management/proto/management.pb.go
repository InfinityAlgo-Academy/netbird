...
var file_management_proto_rawDesc = []byte{
	...
	0x6f, 0x72, 0x74, 0x53, 0x65, 0x6c, 0x65, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x22, 0x8f, 0x02, 0x0a,
	...
	0x6f, 0x63, 0x6f, 0x6c, 0x18, 0x05, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x18, 0x2e, 0x6d, 0x61, 0x6e,
	...
	0x0a, 0x08, 0x70, 0x6f, 0x72, 0x74, 0x49, 0x6e, 0x66, 0x6f, 0x18, 0x06, 0x20, 0x01, 0x28, 0x0b,
	...
	0x12, 0x1c, 0x0a, 0x09, 0x69, 0x73, 0x44, 0x79, 0x6e, 0x61, 0x6d, 0x69, 0x63, 0x18, 0x07, 0x20,
	0x01, 0x28, 0x08, 0x52, 0x09, 0x69, 0x73, 0x44, 0x79, 0x6e, 0x61, 0x6d, 0x69, 0x63, 0x2a, 0x40,
...
var file_management_proto_goTypes = []interface{}{
	...
	(*PortInfo)(nil),                       // 38: management.PortInfo
	(*RouteFirewallRule)(nil),              // 39: management.RouteFirewallRule
	(*PortInfo_Range)(nil),                 // 40: management.PortInfo.Range
...
var file_management_proto_depIdxs = []int32{
	...
	41, // 15: management.ServerKeyResponse.expiresAt:type_name -> google.protobuf.Timestamp
	...
	39, // 28: management.NetworkMap.routesFirewallRules:type_name -> management.RouteFirewallRule
	23, // 29: management.RemotePeerConfig.sshConfig:type_name -> management.SSHConfig
	4,  // 30: management.DeviceAuthorizationFlow.Provider:type_name -> management.DeviceAuthorizationFlow.provider
	28, // 31: management.DeviceAuthorizationFlow.ProviderConfig:type_name -> management.ProviderConfig
	28, // 32: management.PKCEAuthorizationFlow.ProviderConfig:type_name -> management.ProviderConfig
	33, // 33: management.DNSConfig.NameServerGroups:type_name -> management.NameServerGroup
	31, // 34: management.DNSConfig.CustomZones:type_name -> management.CustomZone
	32, // 35: management.CustomZone.Records:type_name -> management.SimpleRecord
	34, // 36: management.NameServerGroup.NameServers:type_name -> management.NameServer
	...
	40, // 40: management.PortInfo.range:type_name -> management.PortInfo.Range
	2,  // 41: management.RouteFirewallRule.action:type_name -> management.RuleAction
	0,  // 42: management.RouteFirewallRule.protocol:type_name -> management.RuleProtocol
	38, // 43: management.RouteFirewallRule.portInfo:type_name -> management.PortInfo
	5,  // 44: management.ManagementService.Login:input_type -> management.EncryptedMessage
	5,  // 45: management.ManagementService.Sync:input_type -> management.EncryptedMessage
	16, // 46: management.ManagementService.GetServerKey:input_type -> management.Empty
	16, // 47: management.ManagementService.isHealthy:input_type -> management.Empty
	5,  // 48: management.ManagementService.GetDeviceAuthorizationFlow:input_type -> management.EncryptedMessage
	5,  // 49: management.ManagementService.GetPKCEAuthorizationFlow:input_type -> management.EncryptedMessage
	5,  // 50: management.ManagementService.SyncMeta:input_type -> management.EncryptedMessage
	5,  // 51: management.ManagementService.Login:output_type -> management.EncryptedMessage
	5,  // 52: management.ManagementService.Sync:output_type -> management.EncryptedMessage
	15, // 53: management.ManagementService.GetServerKey:output_type -> management.ServerKeyResponse
	16, // 54: management.ManagementService.isHealthy:output_type -> management.Empty
	5,  // 55: management.ManagementService.GetDeviceAuthorizationFlow:output_type -> management.EncryptedMessage
	5,  // 56: management.ManagementService.GetPKCEAuthorizationFlow:output_type -> management.EncryptedMessage
	16, // 57: management.ManagementService.SyncMeta:output_type -> management.Empty
